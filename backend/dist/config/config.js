...
const envVarsSchema = joi_1.default.object()
    ...
    PROD_DB_USER: joi_1.default.string()
        .required()
        .description("Database Production Username"),
    PROD_DB_PASSWORD: joi_1.default.string()
        .required()
    ...
    API_KEY: joi_1.default.string().description("api key for fetch data"),
})
    .unknown();
